  ...
  document.querySelector('#modal-body').innerHTML = `
    <form id="edit-book-form" class="mb-4">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="pin-title" aria-describedby="pinTitle" placeholder="Enter Board Title" value="${pinObject.pinTitle}">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label for="price">Edit Pin Image</label>
